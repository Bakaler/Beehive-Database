...
be accessed by multiple functions during the request. The connection is stored and 
reused instead of creating a new connection if get_db is called a second time in the same request.
...
sqlite3.connect() establishes a connection to the file pointed at by the DATABASE configuration key. This file doesnt 
have to exist yet, and wont until you initialize the database later.
...
since you wont necessarily know where that location is when deploying the application later. 
...
#===================================#
##TODO REGISTER with the APPLICATION#
#===================================#
